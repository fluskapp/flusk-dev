 ...
 *
 * `flusk prompt` prints it for a human to copy and the flow runtime sends it to a
 ...
 *
 * `why` is the single knob. `flusk prompt` puts each block's justification in its
