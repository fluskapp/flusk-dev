...
import type { FluskConfig, ModelChoice, RepoConfig } from "../../platform/config/types.js";
...
import { newRunId, recordFlowRun } from "./record.repository.js";
...
export interface RunFlowOpts {
	...
	/** What a step cost. LangChain reports no price, so flusk supplies one. */
...
export async function runFlow(
	...
	try {
		...
		const at = { repoRoot: opts.repoRoot, store: opts.store, runId };
