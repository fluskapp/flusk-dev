...
import { type DocService, makeService } from "./ts-host.repository.js";
import { loadTypeScript } from "./ts-load.js";
import { DEFAULT_FILE_CAP, projectConfig, scanProject } from "./ts-project.repository.js";

export type { DocService } from "./ts-host.repository.js";
