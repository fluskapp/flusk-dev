/**
 * The one place flusk opens a socket to a stranger.
 *
...
const HEADERS: Record<string, string> = {
	...
	"accept-language": "en",
	"user-agent": "flusk-workbench-web-reader",
};
 ...
 * production callers take the constant, and nothing in flusk passes anything
 * else.
 */
