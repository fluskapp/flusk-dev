 ...
 * `<home>/agents/*.md`, ah's own `<home>/agents/generated/*.md`, and the
 * repository's `<repo>/.ah/agents/*.md`.
 *
 ...
 * project-scoped spec may load while `<repo>/.ah/extensions/*.js` (arbitrary
...
export interface RegistryOptions {
	repoRoot: string;
	/** Defaults to `ahHome()`; overridable so tests use a real temp dir. */
	home?: string;
	/**
