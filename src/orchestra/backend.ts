 ...
 * config, which src/config/config.ts refuses from a repo's own .ah.json. An
 ...
 */
import { type ResolvedBackend, resolveBackends } from "../chat/detect.js";
...
export function specBackend(cfg: AhConfig, spec: AgentSpec, want: ChatBackendKind): BackendLookup {
