/**
 * An OpenAI-compatible endpoint as an ah Provider, so a local model
 * (Ollama, LM Studio, vLLM) or an OpenRouter model drives ah's OWN tool loop
...
import type { AssistantBlock, AssistantMsg, StopReason } from "../core/types.js";
