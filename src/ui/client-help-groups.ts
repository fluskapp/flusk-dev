 ...
 * way the workbench is. A shortcut that is not in this file is a shortcut
 * nobody can find. Rendering lives in client-help.ts; the palette appends its
 * own rows into the "Search" group at boot (client-palette.ts).
 */
import type { HelpGroup } from "./client-help.js";
