 ...
 * outside their projects when their .ah.json has a trailing comma.
 */
function graphFail(e, file) {
	...
	return ["The dashboard could not be reached",
		...
		". Check that \`ah ui\` is still running."];
}
...
(function graphInit() {
	...
	document.addEventListener("ah-doc", function (e) { graphFollow(e.detail); });
})();
`;
