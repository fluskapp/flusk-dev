 ...
 *
 * The checkpoints under `<ahHome>/flows/checkpoints/<runId>/steps.jsonl`
 ...
 */
export function attachProjects(rows: FlowRunRow[], cfg: AhConfig): FlowRunRow[] {
...
export async function flowRuns(cfg: AhConfig, opts: FlowRunsOpts = {}): Promise<FlowRunRow[]> {
	let ids: string[] = [];
	try {
