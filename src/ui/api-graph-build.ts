...
import { type BuildReport, buildGraph } from "../graph/build.js";
import { historyCards } from "../history/corpus.js";
import { forgetGraphStores, storeFor } from "./api-graph-target.js";
...
export function buildRoot(cfg: AhConfig, raw: string | null): string | null {
