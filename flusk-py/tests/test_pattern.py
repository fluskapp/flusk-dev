# --- BEGIN GENERATED ---
"""Tests for Pattern entity and repository."""

import sqlite3
import pytest
from flusk.entities.pattern import Pattern
from flusk.storage.sqlite.repositories.pattern_repo import PatternRepository
...
@pytest.fixture
def repo(db: sqlite3.Connection) -> PatternRepository:
    return PatternRepository(db)


class TestPatternEntity:
    """Pattern Pydantic model tests."""
...
class TestPatternRepository:
    """Pattern repository CRUD tests."""

    def test_insert_and_find(self, repo: PatternRepository) -> None:
    ...
    def test_delete(self, repo: PatternRepository) -> None:
