# --- BEGIN GENERATED ---
"""Tests for Insight entity and repository."""

import sqlite3
import pytest
from flusk.entities.insight import Insight
from flusk.storage.sqlite.repositories.insight_repo import InsightRepository
...
@pytest.fixture
def repo(db: sqlite3.Connection) -> InsightRepository:
    return InsightRepository(db)


class TestInsightEntity:
    """Insight Pydantic model tests."""
...
class TestInsightRepository:
    """Insight repository CRUD tests."""

    def test_insert_and_find(self, repo: InsightRepository) -> None:
    ...
    def test_delete(self, repo: InsightRepository) -> None:
