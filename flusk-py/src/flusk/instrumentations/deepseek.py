# --- BEGIN GENERATED ---
"""DeepSeek SDK instrumentation — gen_ai.* OTel spans."""
...
TRACER_NAME = "flusk-deepseek"
_DEEPSEEK_PATCHED = False


def patch_deepseek() -> None:
    """Monkey-patch DeepSeek SDK to emit OTel spans."""
...
def _patch_method(mod: Any, method_path: str) -> None:
    ...
    def patched(self: Any, *a: Any, **kw: Any) -> Any:
        ...
        with tracer.start_as_current_span(
            f"deepseek {model}", kind=SpanKind.CLIENT,
        ) as span:
