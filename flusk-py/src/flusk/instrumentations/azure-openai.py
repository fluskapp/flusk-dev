# --- BEGIN GENERATED ---
"""Azure OpenAI SDK instrumentation — gen_ai.* OTel spans."""
...
TRACER_NAME = "flusk-azure-openai"
_AZURE_OPENAI_PATCHED = False


def patch_azure_openai() -> None:
    """Monkey-patch Azure OpenAI SDK to emit OTel spans."""
    global _AZURE_OPENAI_PATCHED
...
def _patch_method(mod: Any, method_path: str) -> None:
    ...
    def patched(self: Any, *a: Any, **kw: Any) -> Any:
        ...
        with tracer.start_as_current_span(
            f"azure-openai {model}", kind=SpanKind.CLIENT,
        ) as span:
