/**
 * Python SQLite exporter template — SpanExporter → SQLite.
 * WHY: Generates a SpanExporter writing OTel spans to SQLite.
 */

/** Render otel/sqlite_exporter.py */
export function renderSqliteExporter(): string {
