/**
 * Python CLI template — generates click-based CLI commands.
 *
 * WHY: Separates template logic from generator orchestration,
 * keeping both files under 100 lines.
 */

/** Render main.py — the top-level click group */
export function renderMainCli(): string {
...
/** Render analyze.py — the main analysis command */
export function renderAnalyzeCli(): string {
  return `# --- BEGIN GENERATED ---
