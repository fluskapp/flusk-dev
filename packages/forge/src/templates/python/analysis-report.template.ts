/**
 * Python analysis report template — report formatting and session queries.
 *
 * WHY: Split from analysis.template.ts to keep both files under 100 lines.
 */

/** Render analysis/report.py */
export function renderReportAnalysis(): string {
