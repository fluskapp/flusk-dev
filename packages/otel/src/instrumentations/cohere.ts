 ...
 * Cohere SDK instrumentation — gen_ai.* spans
 */
import { trace, SpanKind, SpanStatusCode, context } from '@opentelemetry/api';

const TRACER_NAME = 'flusk-cohere';

export function patchCohere(): void {
  try {
    import('cohere-ai').then((mod) => {
...
function patchMethod(Sdk: any): void {
  ...
  proto.chat = function patched(this: any, body: any, opts?: any) {
    ...
    return tracer.startActiveSpan(
      ...
      context.active(),
      async (span) => {
        span.setAttribute('gen_ai.system', 'cohere');
