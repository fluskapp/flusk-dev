...
export const LLMCallEntitySchema = Type.Composite([
  ...
  Type.Object({
    ...
    consentGiven: Type.Boolean({
      description: 'GDPR consent flag - whether user consented to data processing',
      default: true
    }),
