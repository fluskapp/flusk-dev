...
export async function generateExecution(entityPath, entityName) {
    const results = [];
    // Generate routes
...
async function generateRoutes(entityName) {
...
async function generatePlugin(entityName) {
...
async function generateHooks(entityName) {
...
//# sourceMappingURL=execution.generator.js.map