...
exports.generateFastifyPluginCommand = void 0;
// --- BEGIN GENERATED ---
var commander_1 = require("commander");
var chalk_1 = require("chalk");
var forge_1 = require("@flusk/forge");
exports.generateFastifyPluginCommand = new commander_1.Command('g:fastify-plugin')
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                ...
                console.log(chalk_1.default.blue("\n\uD83D\uDD0C Generating Fastify plugin: ".concat(name, "\n")));
                _b.label = 1;
            case 1:
                _b.trys.push([1, 3, , 4]);
                return [4 /*yield*/, (0, forge_1.generateFastifyPlugin)({
                        name: name,
