...
exports.dashboardCommand = new commander_1.Command('dashboard')
    ...
    .option('--endpoint <url>', 'Flusk server URL', 'http://localhost:3000')
    .option('--api-key <key>', 'Flusk API key')
    .action(function (opts) { return __awaiter(void 0, void 0, void 0, function () {
    var renderDashboard;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, Promise.resolve().then(function () { return require('../tui/app.js'); })];
            case 1:
                renderDashboard = (_a.sent()).renderDashboard;
                return [4 /*yield*/, renderDashboard(opts)];
            case 2:
                _a.sent();
                return [2 /*return*/];
        }
