...
import { hashPromptHook, checkCacheHook, calculateCostHook, cacheResponseHook } from '../../hooks/llm-call.hooks.js';
 ...
 */
export function registerCreateLLMCall(fastify) {
    fastify.post('/', {
        schema: {
...
//# sourceMappingURL=create-llm-call.js.map